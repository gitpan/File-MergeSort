# This Makefile is for the File::MergeSort extension to perl.
#
...
#
#   MakeMaker ARGV: (q[PREFIX=/home/baz/lib/])
#
#   MakeMaker Parameters:

#     ABSTRACT_FROM => q[MergeSort.pm]
#     AUTHOR => q[Christopher Brown <Chris.Brown@cal.berkeley.edu>]
#     NAME => q[File::MergeSort]
#     PREREQ_PM => { Test::More=>q[0], IO::File=>q[0] }
#     VERSION_FROM => q[MergeSort.pm]
...
FULLEXT = File/MergeSort
BASEEXT = MergeSort
PARENT_NAME = File
DLBASE = $(BASEEXT)
VERSION_FROM = MergeSort.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
...
TO_INST_PM = MergeSort.pm

PM_TO_BLIB = MergeSort.pm \
	$(INST_LIB)/File/MergeSort.pm
...
DISTNAME = File-MergeSort
DISTVNAME = File-MergeSort-1.13
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  MergeSort.pm $(INST_MAN3DIR)/File::MergeSort.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(MAKEFILE_OLD) $(FIRST_MAKEFILE) $(INST_LIB)/File/MergeSort.pm
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         File-MergeSort' >> META.yml
	$(NOECHO) $(ECHO) 'version:      1.13' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: MergeSort.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    IO::File:                      0' >> META.yml
...
$(FIRST_MAKEFILE) : Makefile.PL $(CONFIGDEP)
	...
	$(PERLRUN) Makefile.PL "PREFIX=/home/baz/lib/"
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Mergesort ordered files.</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Christopher Brown &lt;Chris.Brown@cal.berkeley.edu&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  MergeSort.pm $(INST_LIB)/File/MergeSort.pm 
	$(NOECHO) $(TOUCH) $@
